...
*   **Stone Pickaxe**: [Rough Stone + Oak Log + Cordage] -> **Unlocks Ores/Minerals**.
...
*   **Unfired Brick**: [Clay Paste + Brick Mold] -> Must be sun-dried.
*   **Primitive Kiln**: See [CRAFTING_STATIONS.md] -> Requires Unfired Bricks.
*   **Fired Brick**: [Unfired Brick + Primitive Kiln] -> Structural masonry.
...
*   **Needle & Thread**: [Bone Shard + Cordage] -> Tool for tailoring.
...
*   **Mechanical Gears**: [Copper Ingot + Iron Ingot + Anvil] -> Kinetic parts.
