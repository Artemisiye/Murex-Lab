# Murex Lab: Comprehensive Item Master List
...
4.  **Raw Clay**: Riverbed sediment.
5.  **Flint Shard**: Sharp stone from outcrops.
6.  **Limestone**: Soft sedimentary rock.
7.  **Raw Hide**: Harvested from wildlife.
...
43. **Stone Shovel**: For clay/sand.
44. **Flint Knife**: For skinning/herbs.
45. **Needle & Thread**: Bone needle + Cordage (For sewing).
46. **Leather Satchel**: Small inventory boost.
47. **Tanned Backpack**: Significant inventory boost.
48. **Oil Lamp**: Clay pottery + Tallow + Cordage (Portable light).
...
54. **Longbow**: Wood + Cordage + Leather.
55. **Round Shield**: Wood + Leather + Bronze.
...
61. **Focusing Lens**: Polished glass for lab optics.
62. **Mechanical Gears**: Copper/Iron precision parts.
63. **Sundial**: Stone + Gnomon (For time tracking).
...
69. **Vegetable Mash**: Grown herbs/seeds.
